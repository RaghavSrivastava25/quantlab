...
const CATEGORIES = [
  ...
  { key: "brain",       label: "Brain Teasers", color: "#ec4899", desc: "PuzzledQuant, Brainstellar puzzles" },
];

const STATS = [
  { value: "8",   label: "Categories" },
  { value: "60+", label: "Problems" },
...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-dark-900">
      ...
      {/* Extra dark overlay so text is readable over grid */}
      ...
      <div className="relative z-10">
        ...
        <section className="max-w-6xl mx-auto px-6 pt-24 pb-20 text-center">
          <div className={`transition-all duration-1000 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            ...
            <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-10">
              ...
              explore landmark research papers — compete and level up.
            </p>
            ...
            {CATEGORIES.map(({ key, label, color, desc }) => (
              <Link key={key} href={`/problems?category=${key}`}
                ...
                <div className="relative">
                  ...
                  <h3 className="font-bold text-slate-100 mb-1 group-hover:text-white">{label}</h3>
        ...
        <section className="max-w-6xl mx-auto px-6 pb-24 grid md:grid-cols-3 gap-6">
          {[
            ...
            { icon: Flame,    title: "Daily Streaks",        desc: "Build momentum. Earn badges for consistency and mastery.",          color: "text-orange-400", bg: "bg-orange-400/10 border-orange-400/20" },
            { icon: BookOpen, title: "Research Library",     desc: "Top quant papers with LaTeX math and live code implementations.", color: "text-purple-400", bg: "bg-purple-400/10 border-purple-400/20" },
